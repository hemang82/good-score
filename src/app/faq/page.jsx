...
export default function Page() {
  ...
  return (
    ...
    <div className="flex flex-col items-center mb-12 text-center">
      ...
      <p className="text-text-secondary text-sm md:text-base max-w-2xl">Find quick answers to common questions about your credit score, how UPSCORE works, and our data security practices.</p>
    </div>
    ...
    <div className="max-w-4xl mx-auto space-y-4 md:space-y-5">
      ...
      <details className="bg-white border border-border-light rounded-[1.5rem] p-5 md:p-6 shadow-sm group [&_summary::-webkit-details-marker]:hidden transition-all duration-300">
        ...
        <div className="mt-4 pt-4 border-t border-border-light/50">
          <p className="text-sm text-text-secondary leading-relaxed">
            UPSCORE is a comprehensive credit management platform designed to help you analyze, correct, and sustainably build your credit profile. We securely fetch your official credit reports and provide personalized, step-by-step guidance to help you reach a 750+ score.
          </p>
        </div>
      </details>
      ...
      <details className="bg-white border border-border-light rounded-[1.5rem] p-5 md:p-6 shadow-sm group [&_summary::-webkit-details-marker]:hidden transition-all duration-300">
        ...
        <div className="mt-4 pt-4 border-t border-border-light/50">
          <p className="text-sm text-text-secondary leading-relaxed">
            Yes! Checking your basic credit score (from bureaus like Experian or CIBIL) via UPSCORE is 100% free and will never negatively impact your score (it counts as a "soft inquiry"). We do offer premium personalized plans for advanced credit building if you need extra help.
          </p>
        </div>
      </details>
      ...
      <details className="bg-white border border-border-light rounded-[1.5rem] p-5 md:p-6 shadow-sm group [&_summary::-webkit-details-marker]:hidden transition-all duration-300">
        ...
        <div className="mt-4 pt-4 border-t border-border-light/50">
          <p className="text-sm text-text-secondary leading-relaxed">
            No. When you check your own score through UPSCORE, it is classified as a "soft inquiry" by the bureaus. Soft inquiries have absolutely zero impact on your credit score, no matter how many times you check it.
          </p>
        </div>
      </details>
      ...
      <details className="bg-white border border-border-light rounded-[1.5rem] p-5 md:p-6 shadow-sm group [&_summary::-webkit-details-marker]:hidden transition-all duration-300">
        ...
        <div className="mt-4 pt-4 border-t border-border-light/50">
          <p className="text-sm text-text-secondary leading-relaxed">
            If you spot an unauthorized inquiry, duplicate loan, or incorrect personal detail, you can use our built-in dispute templates. Simply go to the "Credit Report" section, select the erroneous entry, and UPSCORE will generate an official dispute request to send to the respective credit bureau.
          </p>
        </div>
      </details>
      ...
      <details className="bg-white border border-border-light rounded-[1.5rem] p-5 md:p-6 shadow-sm group [&_summary::-webkit-details-marker]:hidden transition-all duration-300">
        <summary className="flex items-center justify-between cursor-pointer text-base md:text-lg font-bold text-dark-green outline-none">
          <span>Is my data secure on UPSCORE?</span>
          <span className="transition-transform duration-300 group-open:-rotate-180 opacity-60 ml-4 shrink-0">
            <svg width="14" height="12" viewBox="0 0 14 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M7 12L0 0H14L7 12Z" />
            </svg>
      ...
      <details className="bg-white border border-border-light rounded-[1.5rem] p-5 md:p-6 shadow-sm group [&_summary::-webkit-details-marker]:hidden transition-all duration-300">
        ...
        <div className="mt-4 pt-4 border-t border-border-light/50">
          <p className="text-sm text-text-secondary leading-relaxed">
            Credit bureaus generally update their records once every 30 to 45 days, depending on when your banks and lenders report your payment data. If you recently paid off a loan or cleared a credit card bill, please allow up to 45 days for the changes to reflect on your UPSCORE dashboard.
          </p>
        </div>
      </details>
